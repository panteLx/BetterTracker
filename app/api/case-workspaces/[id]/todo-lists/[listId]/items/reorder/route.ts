...
import { reorderTodoItems } from "@/lib/services/todo-service";
...
export async function POST(
  ...
  try {
    ...
    await reorderTodoItems(id, listId, body, access.workspaceAccess!.permission);

    await logAuditEvent({
      actorUserId: access.user!.id,
      action: "todo_items_reordered",
